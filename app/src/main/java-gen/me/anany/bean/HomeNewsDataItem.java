...
/**
 * Entity mapped to table "HomeNewsDataItem".
 */
public class HomeNewsDataItem {
    ...
    public HomeNewsDataItem() {
    }

    public HomeNewsDataItem(String id) {
        this.id = id;
    }

    public HomeNewsDataItem(String id, String is_read, String step, String ct, String catid, String thumb, String idx, String account_id, String isext, String title, String read_num, String like_num, String share_num, String wurl, String video, String image_type, String op_mark, String op_mark_iurl, String op_mark_icolor, String account_name, String url, String is_cache, String article_type, String behot_time, String extraImg) {
        this.id = id;
